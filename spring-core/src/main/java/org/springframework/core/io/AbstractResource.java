...
public abstract class AbstractResource implements Resource {
	...
	public boolean exists() {
		// 基于 File 进行判断 Try file existence: can we find the file in the file system?
		if (isFile()) {
			try {
		...
		// 基于 InputStream 进行判断 Fall back to stream existence: can we open the stream?
		try {
	...
	/**
     * <pre> 通过 {@link #exists()} 判断，是否可读 </pre>
     *
	...
	/**
     * <pre> 抛出 FileNotFoundException 异常，交给子类实现 </pre>
     *
	...
	/**
     * <pre> 基于 getURL() 返回的 URL 构建 URI </pre>
     *
	...
	/**
     * <pre> 根据 getInputStream() 的返回结果构建 ReadableByteChannel </pre>
     *
	...
	/**
     * <pre> 获取资源名称，默认返回 null ，交给子类实现 </pre>
     *
